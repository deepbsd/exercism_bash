...
function say_prefix(){
    day_num=$1
    [[ $day_num -eq 1 ]] && \
        echo "On the ${days[$day_num]} day of Christmas my true love gave to me: $(say_gifts $day_num)" | sed 's/and a Partridge/a Partridge/g'\
    || echo "On the ${days[$day_num]} day of Christmas my true love gave to me: $(say_gifts $day_num)"
}
